...
static void my_tasklet_handler(struct tasklet_struct * flag);
...
static int  my_tasklet_function(void)
{
	...
	tasklet_schedule(&my_tasklet);   //tasklet_schedule 
	return 0;
}

static void  my_tasklet_exit()
{
	tasklet_kill(&my_tasklet);     //tasklet_kill remove the tasklet
